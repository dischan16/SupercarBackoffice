...
//					dropvoiture.requestFocus();
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int dialogResult = JOptionPane.showConfirmDialog(null, "Souhaitez-vous quitter la page 'Devis'?", "Warning",
						dialogButton);
		...
		panel_1.add(lblSelectionnerLidentifiantDe);
				...
				btnTable.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						table_devis td = new table_devis(login);
						td.table_devis(login);
					}
				});
